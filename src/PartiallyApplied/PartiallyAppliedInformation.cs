...
public sealed class PartiallyAppliedIncrementalInformation
{
	private readonly Compilation compilation;
	private readonly InvocationExpressionSyntax target;

	public PartiallyAppliedIncrementalInformation(InvocationExpressionSyntax target, Compilation compilation)
	{
