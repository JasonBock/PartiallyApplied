...
public sealed class PartiallyAppliedIncrementalBuilder
{
	private readonly PartiallyAppliedIncrementalInformation information;

	public PartiallyAppliedIncrementalBuilder(PartiallyAppliedIncrementalInformation information)
	{
